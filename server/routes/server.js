...
//   });
  ...
  if(!paymentDetails.amount || !paymentDetails.customerId || !paymentDetails.customerEmail || !paymentDetails.customerPhone) {
      ...
      checksum_lib.genchecksum(params, config.PAYTM_MERCHANT_KEY, function (err, checksum) {
  ...
  app.post("/callback", (req, res) => {
    ...
    req.on('data', function (data) {
     ...
     req.on('end', function () {
       ...
       var result = checksum_lib.verifychecksum(post_data, config.PAYTM_MERCHANT_KEY, checksumhash);
